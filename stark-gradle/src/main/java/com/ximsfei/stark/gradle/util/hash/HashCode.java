 ...
 *
 */
package com.ximsfei.stark.gradle.util.hash;
...
public class HashCode implements Serializable, Comparable<HashCode> {
    ...
    public static HashCode fromInt(int value) {
        return fromBytesNoCopy(new byte[]{(byte)(value >> 24), (byte)(value >> 16), (byte)(value >> 8), (byte)value});
    }
    ...
    public boolean equals(@Nullable Object obj) {
        if (obj == this) {
            return true;
        } else if (obj != null && obj.getClass() == HashCode.class) {
            byte[] a = this.bytes;
