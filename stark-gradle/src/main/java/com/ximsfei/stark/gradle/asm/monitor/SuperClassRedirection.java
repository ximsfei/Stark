...
public class SuperClassRedirection {
    ...
    public static boolean checkNeedRedirect(ClassReader classReader) {
        return SUPER_REDIRECT_MAP.keySet().contains(classReader.getSuperName());
    }
