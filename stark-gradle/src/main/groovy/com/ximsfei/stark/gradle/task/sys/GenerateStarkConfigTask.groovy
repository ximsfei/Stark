...
class GenerateStarkConfigTask extends SysTask<GenerateBuildConfig> {
    ...
    GenerateStarkConfigTask(Project project, AppExtension android, StarkExtension stark, ApkVariant apkVariant) {
        super(project, android, stark, apkVariant)
    }

    @Override
    protected GenerateBuildConfig getTask() {
        return apkVariant.variantData.scope.generateBuildConfigTask
    }
    ...
    void afterExecute() {
        ...
        generator.addField("String", "APK_HASH", '"' + UUID.randomUUID().toString() + '"')
        generator.generate()
    }

    class StarkConfigGenerator {
        public static final String STARK_CONFIG_NAME = "StarkConfig.java"
