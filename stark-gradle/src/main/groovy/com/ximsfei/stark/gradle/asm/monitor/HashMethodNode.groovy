...
class HashMethodNode {
    ...
    static String generateMethodHashCode(MethodNode methodNode) {
        ...
        for (i = 0; i < n; i++) {
            ...
            methodBuilder.append(parameter.access)
        }
        // visits the method's code
        if (methodNode.instructions.size() > 0) {
            // visits try catch blocks
            n = methodNode.tryCatchBlocks == null ? 0 : methodNode.tryCatchBlocks.size()
            for (i = 0; i < n; ++i) {
                methodBuilder.append(methodNode.tryCatchBlocks.get(i).type)
//                tryCatchBlocks.get(i).updateIndex(i)
//                tryCatchBlocks.get(i).accept(mv)
            }
            // visits instructions
            AbstractInsnNode insn = methodNode.instructions.first
            while (insn != null) {
//                insn.accept()
                switch (insn.type) {
                    ...
                    case AbstractInsnNode.INT_INSN:
                         ...
                         */
                        methodBuilder.append(((IntInsnNode) insn).type)
                        methodBuilder.append(((IntInsnNode) insn).opcode)
                        break
                    case AbstractInsnNode.VAR_INSN:
                        ...
                        methodBuilder.append(insn.type)
                        methodBuilder.append(insn.opcode)
                        methodBuilder.append(((VarInsnNode) insn).var)
                        break
                    case AbstractInsnNode.TYPE_INSN:
                        ...
                        methodBuilder.append(insn.type)
                        methodBuilder.append(insn.opcode)
                        methodBuilder.append(((TypeInsnNode) insn).desc)
                        break
                    case AbstractInsnNode.FIELD_INSN:
                        ...
                        methodBuilder.append(insn.type)
                        methodBuilder.append(insn.opcode)
                        methodBuilder.append(((FieldInsnNode) insn).owner)
                        methodBuilder.append(((FieldInsnNode) insn).name)
                        methodBuilder.append(((FieldInsnNode) insn).desc)
                        break
                    case AbstractInsnNode.METHOD_INSN:
                        ...
                        methodBuilder.append(insn.type)
                        methodBuilder.append(insn.opcode)
                        methodBuilder.append(((MethodInsnNode) insn).owner)
                        methodBuilder.append(((MethodInsnNode) insn).name)
                        methodBuilder.append(((MethodInsnNode) insn).desc)
                        methodBuilder.append(((MethodInsnNode) insn).itf)
                        break
                    case AbstractInsnNode.INVOKE_DYNAMIC_INSN:
                        ...
                        methodBuilder.append(insn.type)
                        methodBuilder.append(insn.opcode)
                        methodBuilder.append(((InvokeDynamicInsnNode) insn).name)
                        methodBuilder.append(((InvokeDynamicInsnNode) insn).desc)
                        methodBuilder.append(((InvokeDynamicInsnNode) insn).bsm.tag)
                    ...
                    case AbstractInsnNode.LDC_INSN:
                        ...
                        methodBuilder.append(insn.type)
                        methodBuilder.append(insn.opcode)
                        methodBuilder.append(((LdcInsnNode) insn).cst)
                        break
                    case AbstractInsnNode.IINC_INSN:
                        ...
                        methodBuilder.append(insn.type)
                        methodBuilder.append(insn.opcode)
                        methodBuilder.append(((IincInsnNode) insn).var)
                        methodBuilder.append(((IincInsnNode) insn).incr)
                        break
                    case AbstractInsnNode.TABLESWITCH_INSN:
                        ...
                        methodBuilder.append(insn.type)
                        methodBuilder.append(insn.opcode)
                        methodBuilder.append(((TableSwitchInsnNode) insn).min)
                    ...
                    case AbstractInsnNode.MULTIANEWARRAY_INSN:
                        ...
                        methodBuilder.append(insn.type)
                        methodBuilder.append(insn.opcode)
                        methodBuilder.append(((MultiANewArrayInsnNode) insn).desc)
                        methodBuilder.append(((MultiANewArrayInsnNode) insn).dims)
                        break
                    case AbstractInsnNode.FRAME:
                        ...
                        methodBuilder.append(insn.type)
                        methodBuilder.append(insn.opcode)
                        for (Object local : ((FrameNode) insn).local) {
                            methodBuilder.append(local)
                        }
                        for (Object stack : ((FrameNode) insn).stack) {
                            methodBuilder.append(stack)
                        }
                        break
...
//            instructions.accept(mv)
            ...
            n = methodNode.localVariables == null ? 0 : methodNode.localVariables.size()
            for (i = 0; i < n; ++i) {
                LocalVariableNode localVariableNode = methodNode.localVariables.get(i)
                methodBuilder.append(localVariableNode.name)
                methodBuilder.append(localVariableNode.desc)
                methodBuilder.append(localVariableNode.signature)
//                methodBuilder.append(localVariableNode.start.getLabel())
//                methodBuilder.append(localVariableNode.end.getLabel())
                methodBuilder.append(localVariableNode.index)
