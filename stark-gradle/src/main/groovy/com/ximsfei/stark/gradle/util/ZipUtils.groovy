...
final class ZipUtils {
    ...
    static ZipUtils with(File file) {
     ...
     */
    ZipUtils deleteAll(Set<String> deletes) {
     ...
     */
    private
    synchronized void writeBytes(ZipFile zf, ZipEntry ze, ZipOutputStream os) throws IOException {
        int n
